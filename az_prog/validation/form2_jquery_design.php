...
<form name="jq_form" action="form2_submit.php" method="post" enctype="multipart/form-data" onSubmit="return val_form()" >
...
<table bgcolor="linen"  align="center" >
    ...
    <tr>
      ...
      <td>: </td>
      <td>
        <select id="c_choice" name="choice" onChange="c_name()" >
         <option></option>
