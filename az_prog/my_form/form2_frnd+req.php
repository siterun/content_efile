...
$sentquery = "SELECT *from friend_requests where sender_id='$uid' AND req_status='7'";
$sentquery_check = mysql_query($sentquery) or die(mysql_error());
   //$sentfetch_all = mysql_fetch_array($sentquery_check);

$receivequery = "SELECT *from friend_requests where receiver_id='$uid' AND req_status='7'";
$receivequery_check = mysql_query($receivequery) or die(mysql_error());
   //$receivefetch_all = mysql_fetch_array($receivequery_check);

$frndquery = "SELECT *from friend_requests where receiver_id='$uid' AND req_status='8' || sender_id='$uid' && req_status='8'";
